...
export default class PortDate extends React.Component {
    constructor(props) {
        ...
        const dateValue = props.initalDate ? moment(props.initalDate) : moment();
        const idHidden = props.initialDate ? false : true;
    ...
    render() {
        ...
        const { isLoaded, isHidden, dateValue } = this.state;
